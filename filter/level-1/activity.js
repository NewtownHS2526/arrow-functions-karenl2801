...
const exercise1Result1 = exercise1Array.filter(num => num % 2 !== 0);


// Your solution here (regular arrow function):
const exercise1Result2 = exercise1Array.filter((num) => { 
  return num % 2 !== 0;
});
...
// Your solution here (one-line arrow function):
const exercise3Result1 = exercise3Array.filter(num => num > 10);
