...
// Your solution here (one-line arrow function):
exercise2Array.forEach(num => { if (num % 2 === 0) console.log(num); });
...
// Your solution here (one-line arrow function):
exercise4Array.forEach((num, i) => exercise4Result += (i === 0 ? "" : " -> ") + num);

// Your solution here (regular arrow function):
exercise4Array.forEach((num, i) => {
  if (i === 0) {
    exercise4Result += num;
  } else {
    exercise4Result += " -> " + num;
...
// Your solution here (one-line arrow function):
exercise5Array.forEach(num => { if (num > 20) exercise5Count++; });
